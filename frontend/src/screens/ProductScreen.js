...
const ProductScreen = ({ history, match }) => {
  ...
  useEffect(() => {
    ...
    if (!product._id || product.productId !== match.params.id) {
      dispatch(listProductDetails(match.params.id));
      dispatch({ type: PRODUCT_CREATE_REVIEW_RESET });
    }
  }, [dispatch, match, successProductReview, product.numReviews]);
    ...
    <>
      ...
      {loading ? (
        ...
        <>
          ...
          <Row>
            <Col md={6}>
              <Image src={window.location.origin + '/' + product.image} fluid />
            </Col>
            <Col md={3}>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  ...
                  {successProductReview && (
                    <Message variant="success">Отзыв оставлен</Message>
                  )}
                  ...
                  {userInfo ? (
                    ...
                    <Message>
                      Пожалуйста <Link to="/login">авторизуйтесь,</Link> чтобы
                      оставить отзыв{" "}
                    </Message>
                  )}
                </ListGroup.Item>
