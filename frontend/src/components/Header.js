  ...
  return (
    <header>
      <Navbar bg="dark" variant="dark" expand="lg" collapseOnSelect>
        <Container>
          <LinkContainer to="/">
            <Navbar.Brand>МегаБаза</Navbar.Brand>
          </LinkContainer>
            ...
            <Nav className="ml-auto">
              ...
              {userInfo ? (
                ...
                <LinkContainer to="/login">
                  <Nav.Link>
                    <i className="fas fa-user"></i> Авторизоваться
                  </Nav.Link>
                </LinkContainer>
              )}
              {userInfo && userInfo.isAdmin && (
                <NavDropdown title="Admin" id="adminmenu">
                  ...
                  <LinkContainer to="/admin/notfoundredactor">
                    <NavDropdown.Item>404 страница</NavDropdown.Item>
                  </LinkContainer>
                </NavDropdown>
              )}
            </Nav>
